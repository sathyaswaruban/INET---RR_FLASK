...
SERVICE_CONFIGS = {
    ...
    "ASTRO": {
        "required_columns": ["REFID"],
        "status_mapping": {"Processed": "success", "Rolled Back": "intiated"},
...
def outward_service_selection(
    ...
    """Handle outward service selection and processing."""
...
def unified_filtering_data(
    ...
    mismatched = matched[
        matched[mismatch_db_col].astype(str).str.lower()
        != matched[mismatch_excel_col].astype(str).str.lower()
    ].copy()
